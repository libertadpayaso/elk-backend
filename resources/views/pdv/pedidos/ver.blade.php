			...
			<div class="container">
				<div class="row">
					<div class="col 12 miga">
						<p>
							<a href="{{ url('pdv/pedidos/') }}">Pedidos</a> > {{'Pedido del '.$pedido->created_at}}
						</p>
					</div>
				</div>
				<div class="row">
					<div class="col s12">
						<a class="btn right" href="{{ url('pdv/pedidos/descargar/'.$pedido->id) }}">Descargar</a>
					</div>
				</div>
				<div class="row">
					<div class="col s12">
						<table class="highlight bordered">
							...
							<tbody>
								...
								<tr>
									<td><img class="responsive-img materialboxed" src="{{ asset('assets/img/imagenes/' . $linea->imagen->producto->getImagen()) }}"></td>
